...
import type { CertificateAsset as _CertificateAsset, ExternalBlob as _ExternalBlob, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCertificates(): Promise<Array<CertificateAsset>> {
        if (this.processError) {
            try {
    ...
    async uploadCertificate(arg0: string, arg1: ExternalBlob): Promise<CertificateAsset> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadCertificate(arg0, await to_candid_ExternalBlob_n17(this._uploadFile, this._downloadFile, arg1));
                return from_candid_CertificateAsset_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
async function from_candid_CertificateAsset_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CertificateAsset): Promise<CertificateAsset> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CertificateAsset>): Promise<Array<CertificateAsset>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CertificateAsset_n11(_uploadFile, _downloadFile, x)));
}
